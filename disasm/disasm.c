...
const struct label label_table_atari[] = {
   { .addr=0x0000, .name="LINZBS", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0000, .name="LINFLG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0001, .name="NGFLAG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0002, .name="CASINI", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0004, .name="RAMLO", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0006, .name="TRAMSZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0007, .name="TSTDAT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0008, .name="WARMST", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0009, .name="BOOT", .bytes=1, .rw='a', .btype=1, .base=16}, // Officially "BOOT?" but I'm not sure the '?' works in all assemblers
   { .addr=0x000A, .name="DOSVEC", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x000C, .name="DOSINI", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x000E, .name="APPMHI", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0010, .name="POKMSK", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0011, .name="BRKKEY", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0012, .name="RTCLOK", .bytes=3, .rw='a', .btype=1, .base=16},
   { .addr=0x0015, .name="BUFADR", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0017, .name="ICCOMT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0018, .name="DSKFMS", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x001A, .name="DSKUTL", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x001C, .name="PTIMOT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x001D, .name="PBPNT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x001E, .name="PBUFSZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x001F, .name="PTEMP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0020, .name="ICHIDZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0021, .name="ICDNOZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0022, .name="ICCOMZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0023, .name="ICSTAZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0024, .name="ICBALZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0025, .name="ICBAHZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0026, .name="ICPTLZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0027, .name="ICPTHZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0028, .name="ICBLLZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0029, .name="ICBLHZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x002A, .name="ICAX1Z", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x002B, .name="ICAX2Z", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x002C, .name="ICAX3Z", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x002D, .name="ICAX4Z", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x002E, .name="ICAX5Z", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x002F, .name="ICAX6Z", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0030, .name="STATUS", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0031, .name="CHKSUM", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0032, .name="BUFRLO", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0033, .name="BUFRHI", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0034, .name="BFENLO", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0035, .name="BFENHI", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0036, .name="CRETRY", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0037, .name="DRETRY", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0036, .name="LTEMP", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0038, .name="BUFRFL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0039, .name="RECVDN", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x003A, .name="XMTDON", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x003B, .name="CHKSNT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x003C, .name="NOCKSM", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x003D, .name="BPTR", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x003E, .name="FTYPE", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x003F, .name="FEOF", .bytes=1, .rw='a', .btype=1, .base=16},
   ...
   { .addr=0x0049, .name="ERRNO", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x004A, .name="CKEY", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x004B, .name="CASSBT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x004A, .name="ZCHAIN", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x004C, .name="DSTAT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x004D, .name="ATRACT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x004E, .name="DRKMSK", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x004F, .name="COLRSH", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0050, .name="TEMP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0051, .name="HOLD1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0052, .name="LMARGN", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0053, .name="RMARGN", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0054, .name="ROWCRS", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0055, .name="COLCRS", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0057, .name="DINDEX", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0058, .name="SAVMSC", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x005A, .name="OLDROW", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x005B, .name="OLDCOL", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x005D, .name="OLDCHR", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x005E, .name="OLDADR", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0060, .name="NEWROW", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0060, .name="FKDEF", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0061, .name="NEWCOL", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0062, .name="PALNTS", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0063, .name="LOGCOL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0064, .name="ADRESS", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0066, .name="MLTTMP", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0068, .name="SAVADR", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x006A, .name="RAMTOP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x006B, .name="BUFCNT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x006C, .name="BUFSTR", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x006E, .name="BITMSK", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x006F, .name="SHFAMT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0070, .name="ROWAC", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0072, .name="COLAC", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0074, .name="ENDPT", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0076, .name="DELTAR", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0077, .name="DELTAC", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0079, .name="ROWINC", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x007A, .name="COLINC", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0079, .name="KEYDEF", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x007B, .name="SWPFLG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x007C, .name="HOLDCH", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x007D, .name="INSDAT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x007E, .name="COUNTR", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0200, .name="VDSLST", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0202, .name="VPRCED", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0204, .name="VINTER", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0206, .name="VBREAK", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0208, .name="VKEYBD", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x020A, .name="VSERIN", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x020C, .name="VSEROR", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x020E, .name="VSEROC", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0210, .name="VTIMR1", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0212, .name="VTIMR2", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0214, .name="VTIMR4", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0216, .name="VIMIRQ", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0218, .name="CDTMV1", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x021A, .name="CDTMV2", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x021C, .name="CDTMV3", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x021E, .name="CDTMV4", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0220, .name="CDTMV5", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0222, .name="VVBLKI", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0224, .name="VVBLKD", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0226, .name="CDTMA1", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0228, .name="CDTMA2", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x022A, .name="CDTMF3", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x022B, .name="SRTIMR", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x022C, .name="CDTMF4", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x022D, .name="INTEMP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x022E, .name="CDTMF5", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x022F, .name="SDMCTL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0230, .name="SDLSTL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0231, .name="SDLSTH", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0232, .name="SSKCTL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0233, .name="SPARE", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0233, .name="LCOUNT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0234, .name="LPENH", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0235, .name="LPENV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0236, .name="BRKKY", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0238, .name="VPIRQ", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x023A, .name="CDEVIC", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x023B, .name="CCOMND", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x023C, .name="CAUX1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x023D, .name="CAUX2", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x023E, .name="TEMP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x023F, .name="ERRFLG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0240, .name="DFLAGS", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0241, .name="DESECT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0242, .name="BOOTAD", .bytes=2, .rw='a', .btype=2, .base=16},
   ...
   { .addr=0x024A, .name="RELADR", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x024C, .name="PPTMPA", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x024D, .name="PPTMPX", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x026B, .name="CHSALT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x026C, .name="VSFLAG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x026D, .name="KEYDIS", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x026E, .name="FINE", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x026F, .name="GPRIOR", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0270, .name="PADDL0", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0271, .name="PADDL1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0272, .name="PADDL2", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0273, .name="PADDL3", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0274, .name="PADDL4", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0275, .name="PADDL5", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0276, .name="PADDL6", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0277, .name="PADDL7", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0278, .name="STICK0", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0279, .name="STICK1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x027A, .name="STICK2", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x027B, .name="STICK3", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x027C, .name="PTRIG0", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x027D, .name="PTRIG1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x027E, .name="PTRIG2", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x027F, .name="PTRIG3", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0280, .name="PTRIG4", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0281, .name="PTRIG5", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0282, .name="PTRIG6", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0283, .name="PTRIG7", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0284, .name="STRIG0", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0285, .name="STRIG1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0286, .name="STRIG2", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0287, .name="STRIG3", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0288, .name="CSTAT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0288, .name="HIBZTE", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0289, .name="WMODE", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x028A, .name="BLIM", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x028B, .name="IMASK", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x028C, .name="JVECK", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x028E, .name="NEWADR", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0290, .name="TXTROW", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0291, .name="TXTCOL", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0293, .name="TINDEX", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0294, .name="TXTMSC", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0296, .name="TXTOLD", .bytes=6, .rw='a', .btype=1, .base=16}, // used for cursor position in split screen mode
   { .addr=0x029C, .name="TMPX1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x029C, .name="CRETRY", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x029D, .name="HOLD3", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x029E, .name="SUBTMP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x029F, .name="HOLD2", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02A0, .name="DMASK", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02A1, .name="TMPLBT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02A2, .name="ESCFLG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02A3, .name="TABMAP", .bytes=15, .rw='a', .btype=1, .base=16}, // map of tab positions
   { .addr=0x02B2, .name="LOGMAP", .bytes=4, .rw='a', .btype=1, .base=16}, // map of logical line breaks
   { .addr=0x02B6, .name="INVFLG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02B7, .name="FILFLG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02B8, .name="TMPROW", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02B9, .name="TMPCOL", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02BB, .name="SCRFLG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02BC, .name="HOLD4", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02BD, .name="HOLD5", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02BD, .name="DRETRY", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02BE, .name="SHFLOK", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02BF, .name="BOTSCR", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02C0, .name="PCOLR0", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02C1, .name="PCOLR1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02C2, .name="PCOLR2", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02C3, .name="PCOLR3", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02C4, .name="COLOR0", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02C5, .name="COLOR1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02C6, .name="COLOR2", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02C7, .name="COLOR3", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02C8, .name="COLOR4", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02C9, .name="RUNADR", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02CB, .name="HIUSED", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02CD, .name="ZHIUSE", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02CF, .name="GBYTEA", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02D1, .name="LOADAD", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02D3, .name="ZLOADA", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02D5, .name="DSCTLN", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02D7, .name="ACMISR", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02D9, .name="KRPDEL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02DA, .name="KEYREP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02DB, .name="NOCLIK", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02FC, .name="HELPFG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02DD, .name="DMASAV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02DE, .name="PBPNT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02DF, .name="PBUFSZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02E0, .name="RUNAD", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02E2, .name="INITAD", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02E4, .name="RAMSIZ", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02E5, .name="MEMTOP", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02E7, .name="MEMLO", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02E9, .name="HNDLOD", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02EA, .name="DVSTAT", .bytes=4, .rw='a', .btype=1, .base=16},
   { .addr=0x02EE, .name="CBAUDL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02EF, .name="CBAUDH", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02F0, .name="CRSINH", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02F1, .name="KEYDEL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02F2, .name="CH1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02F3, .name="CHACT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02F4, .name="CHBAS", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02F5, .name="NEWROW", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02F6, .name="NEWCOL", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x02F8, .name="ROWINC", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02F9, .name="COLINC", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02FA, .name="CHAR", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02FB, .name="ATACHR", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02FC, .name="CH", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02FD, .name="FILDAT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02FE, .name="DSPFLG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x02FF, .name="SSFLAG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0300, .name="DDEVIC", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0301, .name="DUNIT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0302, .name="DCOMND", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0303, .name="DSTATS", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0304, .name="DBUFLO", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0305, .name="DBUFHI", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0306, .name="DTIMLO", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0307, .name="DUNUSE", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0308, .name="DBYTLO", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0309, .name="DBYTHI", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x030A, .name="DAUX1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x030B, .name="DAUX2", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x030C, .name="TIMER1", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x030E, .name="ADDCOR", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x030E, .name="JMPERS", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x030F, .name="CASFLG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0310, .name="TIMER2", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0312, .name="TEMP1", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0314, .name="TEMP2", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0314, .name="PTIMOT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0315, .name="TEMP3", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0316, .name="SAVIO", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0317, .name="TIMFLG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0318, .name="STACKP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0319, .name="TSTAT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x03E8, .name="SUPERF", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x03E9, .name="CKEY", .bytes=1, .rw='a', .btype=1, .base=16},
   ...
   { .addr=0x03FB, .name="CHLINK", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x057E, .name="LBPR1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x057F, .name="LBPR2", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x05E0, .name="PLYARG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD000, .name="HPOSP0", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD000, .name="M0PF", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD001, .name="HPOSP1", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD001, .name="M1PF", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD002, .name="HPOSP2", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD002, .name="M2PF", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD003, .name="HPOSP3", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD003, .name="M3PF", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD004, .name="HPOSM0", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD004, .name="P0PF", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD005, .name="HPOSM1", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD005, .name="P1PF", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD006, .name="HPOSM2", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD006, .name="P2PF", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD007, .name="HPOSM3", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD007, .name="P3PF", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD008, .name="SIZEP0", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD008, .name="M0PL", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD009, .name="SIZEP1", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD009, .name="M1PL", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD00A, .name="SIZEP2", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD00A, .name="M2PL", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD00B, .name="SIZEP3", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD00B, .name="M3PL", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD00C, .name="SIZEM", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD00C, .name="P0PL", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD00D, .name="GRAFP0", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD00D, .name="P1PL", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD00E, .name="GRAFP1", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD00E, .name="P2PL", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD00F, .name="GRAFP2", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD00F, .name="P3PL", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD010, .name="GRAFP3", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD010, .name="TRIG0", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD011, .name="GRAFM", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD011, .name="TRIG1", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD012, .name="COLPM0", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD012, .name="TRIG2", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD013, .name="COLPM1", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD013, .name="TRIG3", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD014, .name="COLPM2", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD014, .name="PAL", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD015, .name="COLPM3", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD016, .name="COLPF0", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD017, .name="COLPF1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD018, .name="COLPF2", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD019, .name="COLPF3", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD01A, .name="COLBK", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD01B, .name="PRIOR", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD01C, .name="VDELAY", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD01D, .name="GRACTL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD01E, .name="HITCLR", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD01F, .name="CONSOL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD200, .name="AUDF1", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD200, .name="POT0", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD201, .name="AUDC1", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD201, .name="POT1", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD202, .name="AUDF2", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD202, .name="POT2", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD203, .name="AUDC2", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD203, .name="POT3", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD204, .name="AUDF3", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD204, .name="POT4", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD205, .name="AUDC3", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD205, .name="POT5", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD206, .name="AUDF4", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD206, .name="POT6", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD207, .name="AUDC4", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD207, .name="POT7", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD208, .name="AUDCTL", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD208, .name="ALLPOT", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD209, .name="STIMER", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD209, .name="KBCODE", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD20A, .name="SKREST", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD20A, .name="RANDOM", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD20B, .name="POTGO", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD20D, .name="SEROUT", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD20D, .name="SERIN", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD20E, .name="IRQEN", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD20E, .name="IRQST", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD20F, .name="SKCTL", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD20F, .name="SKSTAT", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD300, .name="PORTA", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD301, .name="PORTB", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD302, .name="PACTL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD303, .name="PBCTL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD400, .name="DMACTL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD401, .name="CHACTL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD402, .name="DLISTL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD403, .name="DLISTH", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD404, .name="HSCROL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD405, .name="VSCROL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD407, .name="PMBASE", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD409, .name="CHBASE", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD40A, .name="WSYNC", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD40B, .name="VCOUNT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD40C, .name="PENH", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD40D, .name="PENV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD40E, .name="NMIEN", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD40F, .name="NMIST", .bytes=1, .rw='w', .btype=1, .base=16},
   { .addr=0xD40F, .name="NMIRES", .bytes=1, .rw='r', .btype=1, .base=16},
   { .addr=0xD800, .name="AFP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD8E6, .name="FASC", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD9AA, .name="IFP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xD9D2, .name="FPI", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDA44, .name="ZFR0", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDA46, .name="ZF1", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDA60, .name="FSUB", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDA66, .name="FADD", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDADB, .name="FMUL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDB28, .name="FDIV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDD40, .name="PLYEVL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDD89, .name="FLD0R", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDD8D, .name="FLD0P", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDD98, .name="FLD1R", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDD9C, .name="FLD1P", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDDA7, .name="FSTOR", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDDAB, .name="FSTOP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDDB6, .name="FMOVE", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDDC0, .name="EXP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDDCC, .name="EXP10", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDECD, .name="LOG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xDED1, .name="LOG10", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE400, .name="EDITRV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE410, .name="SCRENV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE420, .name="KEYBDV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE430, .name="PRINTV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE440, .name="CASETV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE450, .name="DISKIV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE453, .name="DSKINV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE456, .name="CIOV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE459, .name="SIOV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE45C, .name="SETVBV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE45F, .name="SYSVBV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE462, .name="XITVBV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE465, .name="SIOINV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE468, .name="SENDEV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE46B, .name="INTINV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE46E, .name="CIOINV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE471, .name="BLKBDV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE474, .name="WARMSV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE477, .name="COLDSV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE47A, .name="RBLOKV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE47D, .name="CSOPIV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE480, .name="PUPDIV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE483, .name="SLFTSV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE486, .name="PHENTV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE489, .name="PHULNV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE48C, .name="PHINIV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE48F, .name="GPDVV", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE7AE, .name="SYSVBL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xE7D1, .name="SYSVBL", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0xFFF8, .name="CHKSUN", .bytes=1, .rw='a', .btype=1, .base=16},
...
const struct label label_table_atari_cio[] = {
   ...
   { .addr=0x0380, .name="IOCB4", .bytes=16, .rw='a', .btype=1, .base=16},
...
const struct label label_table_atari_float[] = {
   ...
   { .addr=0x00DA, .name="FRE", .bytes=6, .rw='a', .btype=1, .base=16},
   { .addr=0x00E0, .name="FR1", .bytes=6, .rw='a', .btype=1, .base=16},
   { .addr=0x00E6, .name="FR2", .bytes=6, .rw='a', .btype=1, .base=16},
   { .addr=0x00EC, .name="FRX", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x00ED, .name="EEXP", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x00EE, .name="NSIGN", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x00EF, .name="ESIGN", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x00F0, .name="FCHRFLG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x00F1, .name="DIGRT", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x00F2, .name="CIX", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x00F3, .name="INBUFF", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x00F5, .name="ZTEMP1", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x00F7, .name="ZTEMP4", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x00F9, .name="ZTEMP3", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x00FB, .name="RADFLG", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x00FC, .name="FLPTR", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x00FE, .name="FPTR2", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x05E6, .name="FPSCR", .bytes=6, .rw='a', .btype=1, .base=16},
   { .addr=0x05EC, .name="FPSCR1", .bytes=4, .rw='a', .btype=1, .base=16},
};
const struct label label_table_atari_basic[] = {
   { .addr=0x0080, .name="LOMEM", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0082, .name="VNTP", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0084, .name="VNTD", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0086, .name="VVTP", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0088, .name="STMTAB", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x0090, .name="MEMTOP", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x008A, .name="STMCUR", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x008C, .name="STARP", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x008E, .name="RUNSTK", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x00BA, .name="STOPLN", .bytes=2, .rw='a', .btype=2, .base=16},
   { .addr=0x00C3, .name="ERRSAVE", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x00C9, .name="PTABW", .bytes=1, .rw='a', .btype=1, .base=16},
   { .addr=0x0580, .name="LBUFF", .bytes=128, .rw='a', .btype=1, .base=16}, // BASIC line buffer
};

// Templates for 'orig' value when adding new labels
const struct label label_dec = { .addr=-1, .name="", .bytes=1, .rw='a', .btype=1, .base=10};
const struct label label_word = { .addr=-1, .name="", .bytes=2, .rw='a', .btype=2, .base=16};
      ...
      for ( int base=E_ATASCII_STRING; base >= E_SCREEN_INVERSE_STRING; --base )
      {
         for ( unsigned int s=0; s<ARRAY_SIZE(string_table); ++s )
         {
            ...
            // Expand to collect neighboring characters
            {
               ...
               struct label label_str = { .addr=start, .name="", .bytes=len, .rw='a', .btype=1, .base=base };
