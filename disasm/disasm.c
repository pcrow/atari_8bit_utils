...
// FIXME: Have separate pre-defined tables for Atari OS, Floating Point, and BASIC
// FIXME: Add support for loading user-defined tables; these can be the Lxxxx = $xxxx lines edited
// Create label_tables as an array of tables and initialize it with the defaults
...
const struct label label_table[] = {
   ...
   { 0x0002, "CASINI", 2, 'a', 1, 16 },
   { 0x0004, "RAMLO", 2, 'a', 1, 16 },
   { 0x0006, "TRAMSZ", 1, 'a', 1, 16 },
   { 0x0007, "TSTDAT", 1, 'a', 1, 16 },
   { 0x0008, "WARMST", 1, 'a', 1, 16 },
   { 0x0009, "BOOT", 1, 'a', 1, 16 }, // Officially "BOOT?" but I'm not sure the '?' works in all assemblers
   { 0x000A, "DOSVEC", 2, 'a', 1, 16 },
   { 0x000C, "DOSINI", 2, 'a', 1, 16 },
   { 0x000E, "APPMHI", 2, 'a', 1, 16 },
   { 0x0010, "POKMSK", 1, 'a', 1, 16 },
   { 0x0011, "BRKKEY", 1, 'a', 1, 16 },
   { 0x0012, "RTCLOK", 3, 'a', 1, 16 },
   { 0x0015, "BUFADR", 2, 'a', 1, 16 },
   { 0x0017, "ICCOMT", 1, 'a', 1, 16 },
   { 0x0018, "DSKFMS", 2, 'a', 1, 16 },
   { 0x001A, "DSKUTL", 2, 'a', 1, 16 },
   { 0x001C, "PTIMOT", 1, 'a', 1, 16 },
   { 0x001D, "PBPNT", 1, 'a', 1, 16 },
   { 0x001E, "PBUFSZ", 1, 'a', 1, 16 },
   { 0x001F, "PTEMP", 1, 'a', 1, 16 },
   { 0x0020, "ICHIDZ", 1, 'a', 1, 16 },
   { 0x0021, "ICDNOZ", 1, 'a', 1, 16 },
   { 0x0022, "ICCOMZ", 1, 'a', 1, 16 },
   { 0x0023, "ICSTAZ", 1, 'a', 1, 16 },
   { 0x0024, "ICBALZ", 1, 'a', 1, 16 },
   { 0x0025, "ICBAHZ", 1, 'a', 1, 16 },
   { 0x0026, "ICPTLZ", 1, 'a', 1, 16 },
   { 0x0027, "ICPTHZ", 1, 'a', 1, 16 },
   { 0x0028, "ICBLLZ", 1, 'a', 1, 16 },
   { 0x0029, "ICBLHZ", 1, 'a', 1, 16 },
   { 0x002A, "ICAX1Z", 1, 'a', 1, 16 },
   { 0x002B, "ICAX2Z", 1, 'a', 1, 16 },
   { 0x002C, "ICAX3Z", 1, 'a', 1, 16 },
   { 0x002D, "ICAX4Z", 1, 'a', 1, 16 },
   { 0x002E, "ICAX5Z", 1, 'a', 1, 16 },
   { 0x002F, "ICAX6Z", 1, 'a', 1, 16 },
   { 0x0030, "STATUS", 1, 'a', 1, 16 },
   { 0x0031, "CHKSUM", 1, 'a', 1, 16 },
   { 0x0032, "BUFRLO", 1, 'a', 1, 16 },
   { 0x0033, "BUFRHI", 1, 'a', 1, 16 },
   { 0x0034, "BFENLO", 1, 'a', 1, 16 },
   { 0x0035, "BFENHI", 1, 'a', 1, 16 },
   { 0x0036, "CRETRY", 1, 'a', 1, 16 },
   { 0x0037, "DRETRY", 1, 'a', 1, 16 },
   { 0x0036, "LTEMP", 2, 'a', 1, 16 },
   { 0x0038, "BUFRFL", 1, 'a', 1, 16 },
   { 0x0039, "RECVDN", 1, 'a', 1, 16 },
   { 0x003A, "XMTDON", 1, 'a', 1, 16 },
   { 0x003B, "CHKSNT", 1, 'a', 1, 16 },
   { 0x003C, "NOCKSM", 1, 'a', 1, 16 },
   { 0x003D, "BPTR", 1, 'a', 1, 16 },
   { 0x003E, "FTYPE", 1, 'a', 1, 16 },
   { 0x003F, "FEOF", 1, 'a', 1, 16 },
   { 0x0040, "FREQ", 1, 'a', 1, 16 },
   { 0x0041, "SOUNDR", 1, 'a', 1, 16 },
   { 0x0042, "CRITIC", 1, 'a', 1, 16 },
   //{ 0x0043-0x0049, "FMSZPG", 1, 'a', 1, 16 },
   { 0x0043, "ZBUFP", 2, 'a', 1, 16 },
   { 0x0045, "ZDRVA", 2, 'a', 1, 16 },
   { 0x0047, "ZSBA", 2, 'a', 1, 16 },
   { 0x0049, "ERRNO", 1, 'a', 1, 16 },
   { 0x004A, "CKEY", 1, 'a', 1, 16 },
   { 0x004B, "CASSBT", 1, 'a', 1, 16 },
   { 0x004A, "ZCHAIN", 2, 'a', 1, 16 },
   { 0x004C, "DSTAT", 1, 'a', 1, 16 },
   { 0x004D, "ATRACT", 1, 'a', 1, 16 },
   { 0x004E, "DRKMSK", 1, 'a', 1, 16 },
   { 0x004F, "COLRSH", 1, 'a', 1, 16 },
   { 0x0050, "TEMP", 1, 'a', 1, 16 },
   { 0x0051, "HOLD1", 1, 'a', 1, 16 },
   { 0x0052, "LMARGN", 1, 'a', 1, 16 },
   { 0x0053, "RMARGN", 1, 'a', 1, 16 },
   { 0x0054, "ROWCRS", 1, 'a', 1, 16 },
   { 0x0055, "COLCRS", 2, 'a', 1, 16 },
   { 0x0057, "DINDEX", 1, 'a', 1, 16 },
   { 0x0058, "SAVMSC", 2, 'a', 1, 16 },
   { 0x005A, "OLDROW", 1, 'a', 1, 16 },
   { 0x005B, "OLDCOL", 2, 'a', 1, 16 },
   { 0x005D, "OLDCHR", 1, 'a', 1, 16 },
   { 0x005E, "OLDADR", 2, 'a', 1, 16 },
   { 0x0060, "NEWROW", 1, 'a', 1, 16 },
   { 0x0060, "FKDEF", 2, 'a', 1, 16 },
   { 0x0061, "NEWCOL", 2, 'a', 1, 16 },
   { 0x0062, "PALNTS", 1, 'a', 1, 16 },
   { 0x0063, "LOGCOL", 1, 'a', 1, 16 },
   { 0x0064, "ADRESS", 2, 'a', 1, 16 },
   { 0x0066, "MLTTMP", 2, 'a', 1, 16 },
   { 0x0068, "SAVADR", 2, 'a', 1, 16 },
   { 0x006A, "RAMTOP", 1, 'a', 1, 16 },
   { 0x006B, "BUFCNT", 1, 'a', 1, 16 },
   { 0x006C, "BUFSTR", 2, 'a', 1, 16 },
   { 0x006E, "BITMSK", 1, 'a', 1, 16 },
   { 0x006F, "SHFAMT", 1, 'a', 1, 16 },
   { 0x0070, "ROWAC", 2, 'a', 1, 16 },
   { 0x0072, "COLAC", 2, 'a', 1, 16 },
   { 0x0074, "ENDPT", 2, 'a', 1, 16 },
   { 0x0076, "DELTAR", 1, 'a', 1, 16 },
   { 0x0077, "DELTAC", 2, 'a', 1, 16 },
   { 0x0079, "ROWINC", 1, 'a', 1, 16 },
   { 0x007A, "COLINC", 1, 'a', 1, 16 },
   { 0x0079, "KEYDEF", 2, 'a', 1, 16 },
   { 0x007B, "SWPFLG", 1, 'a', 1, 16 },
   ...
   { 0x0206, "VBREAK", 2, 'a', 1, 16 },
   { 0x0208, "VKEYBD", 2, 'a', 1, 16 },
   { 0x020A, "VSERIN", 2, 'a', 1, 16 },
   { 0x020C, "VSEROR", 2, 'a', 1, 16 },
   { 0x020E, "VSEROC", 2, 'a', 1, 16 },
   { 0x0210, "VTIMR1", 2, 'a', 1, 16 },
   { 0x0212, "VTIMR2", 2, 'a', 1, 16 },
   { 0x0214, "VTIMR4", 2, 'a', 1, 16 },
   { 0x0216, "VIMIRQ", 2, 'a', 1, 16 },
   { 0x0218, "CDTMV1", 2, 'a', 1, 16 },
   { 0x021A, "CDTMV2", 2, 'a', 1, 16 },
   { 0x021C, "CDTMV3", 2, 'a', 1, 16 },
   { 0x021E, "CDTMV4", 2, 'a', 1, 16 },
   { 0x0220, "CDTMV5", 2, 'a', 1, 16 },
   { 0x0222, "VVBLKI", 2, 'a', 1, 16 },
   { 0x0224, "VVBLKD", 2, 'a', 1, 16 },
   { 0x0226, "CDTMA1", 2, 'a', 1, 16 },
   { 0x0228, "CDTMA2", 2, 'a', 1, 16 },
   { 0x022A, "CDTMF3", 1, 'a', 1, 16 },
   { 0x022B, "SRTIMR", 1, 'a', 1, 16 },
   { 0x022C, "CDTMF4", 1, 'a', 1, 16 },
   { 0x022D, "INTEMP", 1, 'a', 1, 16 },
   { 0x022E, "CDTMF5", 1, 'a', 1, 16 },
   { 0x022F, "SDMCTL", 1, 'a', 1, 16 },
   { 0x0230, "SDLSTL", 1, 'a', 1, 16 },
   { 0x0231, "SDLSTH", 1, 'a', 1, 16 },
   { 0x0232, "SSKCTL", 1, 'a', 1, 16 },
   { 0x0233, "SPARE", 1, 'a', 1, 16 },
   { 0x0233, "LCOUNT", 1, 'a', 1, 16 },
   { 0x0234, "LPENH", 1, 'a', 1, 16 },
   { 0x0235, "LPENV", 1, 'a', 1, 16 },
   { 0x0236, "BRKKY", 2, 'a', 1, 16 },
   { 0x0238, "VPIRQ", 2, 'a', 1, 16 },
   { 0x023A, "CDEVIC", 1, 'a', 1, 16 },
   { 0x023B, "CCOMND", 1, 'a', 1, 16 },
   { 0x023C, "CAUX1", 1, 'a', 1, 16 },
   { 0x023D, "CAUX2", 1, 'a', 1, 16 },
   { 0x023E, "TEMP", 1, 'a', 1, 16 },
   { 0x023F, "ERRFLG", 1, 'a', 1, 16 },
   { 0x0240, "DFLAGS", 1, 'a', 1, 16 },
   { 0x0241, "DESECT", 1, 'a', 1, 16 },
   { 0x0242, "BOOTAD", 2, 'a', 1, 16 },
   { 0x0244, "COLDST", 1, 'a', 1, 16 },
   { 0x0245, "RECLEN", 1, 'a', 1, 16 },
   { 0x0246, "DSKTIM", 1, 'a', 1, 16 },
   //{ 0x0247-0x026E, "LINBUF", 1, 'a', 1, 16 }, // 40-character line buffer; not sure about what the other stuff in the same range is
   { 0x0247, "PDVMSK", 1, 'a', 1, 16 },
   { 0x0248, "SHPDVS", 1, 'a', 1, 16 },
   { 0x0249, "PDIMSK", 1, 'a', 1, 16 },
   { 0x024A, "RELADR", 2, 'a', 1, 16 },
   { 0x024C, "PPTMPA", 1, 'a', 1, 16 },
   { 0x024D, "PPTMPX", 1, 'a', 1, 16 },
   { 0x026B, "CHSALT", 1, 'a', 1, 16 },
   { 0x026C, "VSFLAG", 1, 'a', 1, 16 },
   { 0x026D, "KEYDIS", 1, 'a', 1, 16 },
   { 0x026E, "FINE", 1, 'a', 1, 16 },
   { 0x026F, "GPRIOR", 1, 'a', 1, 16 },
   { 0x0270, "PADDL0", 1, 'a', 1, 16 },
   { 0x0271, "PADDL1", 1, 'a', 1, 16 },
   { 0x0272, "PADDL2", 1, 'a', 1, 16 },
   { 0x0273, "PADDL3", 1, 'a', 1, 16 },
   { 0x0274, "PADDL4", 1, 'a', 1, 16 },
   { 0x0275, "PADDL5", 1, 'a', 1, 16 },
   { 0x0276, "PADDL6", 1, 'a', 1, 16 },
   { 0x0277, "PADDL7", 1, 'a', 1, 16 },
   { 0x0278, "STICK0", 1, 'a', 1, 16 },
   { 0x0279, "STICK1", 1, 'a', 1, 16 },
   { 0x027A, "STICK2", 1, 'a', 1, 16 },
   { 0x027B, "STICK3", 1, 'a', 1, 16 },
   { 0x027C, "PTRIG0", 1, 'a', 1, 16 },
   { 0x027D, "PTRIG1", 1, 'a', 1, 16 },
   { 0x027E, "PTRIG2", 1, 'a', 1, 16 },
   { 0x027F, "PTRIG3", 1, 'a', 1, 16 },
   { 0x0280, "PTRIG4", 1, 'a', 1, 16 },
   { 0x0281, "PTRIG5", 1, 'a', 1, 16 },
   { 0x0282, "PTRIG6", 1, 'a', 1, 16 },
   { 0x0283, "PTRIG7", 1, 'a', 1, 16 },
   { 0x0284, "STRIG0", 1, 'a', 1, 16 },
   { 0x0285, "STRIG1", 1, 'a', 1, 16 },
   { 0x0286, "STRIG2", 1, 'a', 1, 16 },
   { 0x0287, "STRIG3", 1, 'a', 1, 16 },
   { 0x0288, "CSTAT", 1, 'a', 1, 16 },
   { 0x0288, "HIBZTE", 1, 'a', 1, 16 },
   { 0x0289, "WMODE", 1, 'a', 1, 16 },
   { 0x028A, "BLIM", 1, 'a', 1, 16 },
   { 0x028B, "IMASK", 1, 'a', 1, 16 },
   { 0x028C, "JVECK", 2, 'a', 1, 16 },
   { 0x028E, "NEWADR", 2, 'a', 1, 16 },
   { 0x0290, "TXTROW", 1, 'a', 1, 16 },
   { 0x0291, "TXTCOL", 2, 'a', 1, 16 },
   { 0x0293, "TINDEX", 1, 'a', 1, 16 },
   { 0x0294, "TXTMSC", 2, 'a', 1, 16 },
   { 0x0296, "TXTOLD", 6, 'a', 1, 16 }, // used for cursor position in split screen mode
   { 0x029C, "TMPX1", 1, 'a', 1, 16 },
   { 0x029C, "CRETRY", 1, 'a', 1, 16 },
   { 0x029D, "HOLD3", 1, 'a', 1, 16 },
   { 0x029E, "SUBTMP", 1, 'a', 1, 16 },
   { 0x029F, "HOLD2", 1, 'a', 1, 16 },
   { 0x02A0, "DMASK", 1, 'a', 1, 16 },
   { 0x02A1, "TMPLBT", 1, 'a', 1, 16 },
   { 0x02A2, "ESCFLG", 1, 'a', 1, 16 },
   { 0x02A3, "TABMAP", 15, 'a', 1, 16 }, // map of tab positions
   { 0x02B2, "LOGMAP", 4, 'a', 1, 16 }, // map of logical line breaks
   { 0x02B6, "INVFLG", 1, 'a', 1, 16 },
   { 0x02B7, "FILFLG", 1, 'a', 1, 16 },
   { 0x02B8, "TMPROW", 1, 'a', 1, 16 },
   { 0x02B9, "TMPCOL", 2, 'a', 1, 16 },
   { 0x02BB, "SCRFLG", 1, 'a', 1, 16 },
   { 0x02BC, "HOLD4", 1, 'a', 1, 16 },
   { 0x02BD, "HOLD5", 1, 'a', 1, 16 },
   { 0x02BD, "DRETRY", 1, 'a', 1, 16 },
   { 0x02BE, "SHFLOK", 1, 'a', 1, 16 },
   { 0x02BF, "BOTSCR", 1, 'a', 1, 16 },
   { 0x02C0, "PCOLR0", 1, 'a', 1, 16 },
   { 0x02C1, "PCOLR1", 1, 'a', 1, 16 },
   { 0x02C2, "PCOLR2", 1, 'a', 1, 16 },
   { 0x02C3, "PCOLR3", 1, 'a', 1, 16 },
   { 0x02C4, "COLOR0", 1, 'a', 1, 16 },
   { 0x02C5, "COLOR1", 1, 'a', 1, 16 },
   { 0x02C6, "COLOR2", 1, 'a', 1, 16 },
   { 0x02C7, "COLOR3", 1, 'a', 1, 16 },
   { 0x02C8, "COLOR4", 1, 'a', 1, 16 },
   { 0x02C9, "RUNADR", 2, 'a', 1, 16 },
   { 0x02CB, "HIUSED", 2, 'a', 1, 16 },
   { 0x02CD, "ZHIUSE", 2, 'a', 1, 16 },
   { 0x02CF, "GBYTEA", 2, 'a', 1, 16 },
   { 0x02D1, "LOADAD", 2, 'a', 1, 16 },
   { 0x02D3, "ZLOADA", 2, 'a', 1, 16 },
   { 0x02D5, "DSCTLN", 2, 'a', 1, 16 },
   { 0x02D7, "ACMISR", 2, 'a', 1, 16 },
   { 0x02D9, "KRPDEL", 1, 'a', 1, 16 },
   { 0x02DA, "KEYREP", 1, 'a', 1, 16 },
   { 0x02DB, "NOCLIK", 1, 'a', 1, 16 },
   { 0x02FC, "HELPFG", 1, 'a', 1, 16 },
   { 0x02DD, "DMASAV", 1, 'a', 1, 16 },
   { 0x02DE, "PBPNT", 1, 'a', 1, 16 },
   { 0x02DF, "PBUFSZ", 1, 'a', 1, 16 },
   { 0x02E0, "RUNAD", 2, 'a', 1, 16 },
   { 0x02E2, "INITAD", 2, 'a', 1, 16 },
   { 0x02E4, "RAMSIZ", 1, 'a', 1, 16 },
   { 0x02E5, "MEMTOP", 2, 'a', 1, 16 },
   { 0x02E7, "MEMLO", 2, 'a', 1, 16 },
   { 0x02E9, "HNDLOD", 1, 'a', 1, 16 },
   { 0x02EA, "DVSTAT", 4, 'a', 1, 16 },
   { 0x02EE, "CBAUDL", 1, 'a', 1, 16 },
   { 0x02EF, "CBAUDH", 1, 'a', 1, 16 },
   { 0x02F0, "CRSINH", 1, 'a', 1, 16 },
   { 0x02F1, "KEYDEL", 1, 'a', 1, 16 },
   { 0x02F2, "CH1", 1, 'a', 1, 16 },
   { 0x02F3, "CHACT", 1, 'a', 1, 16 },
   { 0x02F4, "CHBAS", 1, 'a', 1, 16 },
   { 0x02F5, "NEWROW", 1, 'a', 1, 16 },
   { 0x02F6, "NEWCOL", 2, 'a', 1, 16 },
   { 0x02F8, "ROWINC", 1, 'a', 1, 16 },
   { 0x02F9, "COLINC", 1, 'a', 1, 16 },
   { 0x02FA, "CHAR", 1, 'a', 1, 16 },
   { 0x02FB, "ATACHR", 1, 'a', 1, 16 },
   { 0x02FC, "CH", 1, 'a', 1, 16 },
   { 0x02FD, "FILDAT", 1, 'a', 1, 16 },
   { 0x02FE, "DSPFLG", 1, 'a', 1, 16 },
   { 0x02FF, "SSFLAG", 1, 'a', 1, 16 },
   { 0x0300, "DDEVIC", 1, 'a', 1, 16 },
   { 0x0301, "DUNIT", 1, 'a', 1, 16 },
   { 0x0302, "DCOMND", 1, 'a', 1, 16 },
   { 0x0303, "DSTATS", 1, 'a', 1, 16 },
   { 0x0304, "DBUFLO", 1, 'a', 1, 16 },
   { 0x0305, "DBUFHI", 1, 'a', 1, 16 },
   { 0x0306, "DTIMLO", 1, 'a', 1, 16 },
   { 0x0307, "DUNUSE", 1, 'a', 1, 16 },
   { 0x0308, "DBYTLO", 1, 'a', 1, 16 },
   { 0x0309, "DBYTHI", 1, 'a', 1, 16 },
   { 0x030A, "DAUX1", 1, 'a', 1, 16 },
   { 0x030B, "DAUX2", 1, 'a', 1, 16 },
   { 0x030C, "TIMER1", 2, 'a', 1, 16 },
   { 0x030E, "ADDCOR", 1, 'a', 1, 16 },
   { 0x030E, "JMPERS", 1, 'a', 1, 16 },
   { 0x030F, "CASFLG", 1, 'a', 1, 16 },
   { 0x0310, "TIMER2", 2, 'a', 1, 16 },
   { 0x0312, "TEMP1", 2, 'a', 1, 16 },
   { 0x0314, "TEMP2", 1, 'a', 1, 16 },
   { 0x0314, "PTIMOT", 1, 'a', 1, 16 },
   { 0x0315, "TEMP3", 1, 'a', 1, 16 },
   { 0x0316, "SAVIO", 1, 'a', 1, 16 },
   ...
   { 0x03EB, "CARTCK", 1, 'a', 1, 16 },
   { 0x03EC, "DEERF", 1, 'a', 1, 16 },
   //{ 0x03ED-0x03F7, "ACMVAR", 1, 'a', 1, 16 },
   { 0x03F8, "BASICF", 1, 'a', 1, 16 },
   ...
   { 0xD001, "M1PF", 1, 'r', 1, 16 },
   { 0xD002, "HPOSP2", 1, 'w', 1, 16 },
   { 0xD002, "M2PF", 1, 'r', 1, 16 },
   { 0xD003, "HPOSP3", 1, 'w', 1, 16 },
   { 0xD003, "M3PF", 1, 'r', 1, 16 },
   { 0xD004, "HPOSM0", 1, 'w', 1, 16 },
   { 0xD004, "P0PF", 1, 'r', 1, 16 },
   { 0xD005, "HPOSM1", 1, 'w', 1, 16 },
   { 0xD005, "P1PF", 1, 'r', 1, 16 },
   { 0xD006, "HPOSM2", 1, 'w', 1, 16 },
   { 0xD006, "P2PF", 1, 'r', 1, 16 },
   { 0xD007, "HPOSM3", 1, 'w', 1, 16 },
   { 0xD007, "P3PF", 1, 'r', 1, 16 },
   { 0xD008, "SIZEP0", 1, 'w', 1, 16 },
   { 0xD008, "M0PL", 1, 'r', 1, 16 },
   { 0xD009, "SIZEP1", 1, 'w', 1, 16 },
   { 0xD009, "M1PL", 1, 'r', 1, 16 },
   { 0xD00A, "SIZEP2", 1, 'w', 1, 16 },
   { 0xD00A, "M2PL", 1, 'r', 1, 16 },
   { 0xD00B, "SIZEP3", 1, 'w', 1, 16 },
   { 0xD00B, "M3PL", 1, 'r', 1, 16 },
   { 0xD00C, "SIZEM", 1, 'w', 1, 16 },
   { 0xD00C, "P0PL", 1, 'r', 1, 16 },
   { 0xD00D, "GRAFP0", 1, 'w', 1, 16 },
   { 0xD00D, "P1PL", 1, 'r', 1, 16 },
   { 0xD00E, "GRAFP1", 1, 'w', 1, 16 },
   { 0xD00E, "P2PL", 1, 'r', 1, 16 },
   { 0xD00F, "GRAFP2", 1, 'w', 1, 16 },
   { 0xD00F, "P3PL", 1, 'r', 1, 16 },
   { 0xD010, "GRAFP3", 1, 'w', 1, 16 },
   { 0xD010, "TRIG0", 1, 'r', 1, 16 },
   { 0xD011, "GRAFM", 1, 'w', 1, 16 },
   { 0xD011, "TRIG1", 1, 'r', 1, 16 },
   { 0xD012, "COLPM0", 1, 'w', 1, 16 },
   { 0xD012, "TRIG2", 1, 'r', 1, 16 },
   { 0xD013, "COLPM1", 1, 'w', 1, 16 },
   { 0xD013, "TRIG3", 1, 'r', 1, 16 },
   { 0xD014, "COLPM2", 1, 'w', 1, 16 },
   { 0xD014, "PAL", 1, 'r', 1, 16 },
   { 0xD015, "COLPM3", 1, 'a', 1, 16 },
   { 0xD016, "COLPF0", 1, 'a', 1, 16 },
   { 0xD017, "COLPF1", 1, 'a', 1, 16 },
   { 0xD018, "COLPF2", 1, 'a', 1, 16 },
   { 0xD019, "COLPF3", 1, 'a', 1, 16 },
   { 0xD01A, "COLBK", 1, 'a', 1, 16 },
   { 0xD01B, "PRIOR", 1, 'a', 1, 16 },
   { 0xD01C, "VDELAY", 1, 'a', 1, 16 },
   { 0xD01D, "GRACTL", 1, 'a', 1, 16 },
   { 0xD01E, "HITCLR", 1, 'a', 1, 16 },
   { 0xD01F, "CONSOL", 1, 'a', 1, 16 },
   { 0xD200, "AUDF1", 1, 'w', 1, 16 },
   { 0xD200, "POT0", 1, 'r', 1, 16 },
   { 0xD201, "AUDC1", 1, 'w', 1, 16 },
   { 0xD201, "POT1", 1, 'r', 1, 16 },
   { 0xD202, "AUDF2", 1, 'w', 1, 16 },
   { 0xD202, "POT2", 1, 'r', 1, 16 },
   { 0xD203, "AUDC2", 1, 'w', 1, 16 },
   { 0xD203, "POT3", 1, 'r', 1, 16 },
   { 0xD204, "AUDF3", 1, 'w', 1, 16 },
   { 0xD204, "POT4", 1, 'r', 1, 16 },
   { 0xD205, "AUDC3", 1, 'w', 1, 16 },
   { 0xD205, "POT5", 1, 'r', 1, 16 },
   { 0xD206, "AUDF4", 1, 'w', 1, 16 },
   { 0xD206, "POT6", 1, 'r', 1, 16 },
   { 0xD207, "AUDC4", 1, 'w', 1, 16 },
   { 0xD207, "POT7", 1, 'r', 1, 16 },
   { 0xD208, "AUDCTL", 1, 'w', 1, 16 },
   { 0xD208, "ALLPOT", 1, 'r', 1, 16 },
   { 0xD209, "STIMER", 1, 'w', 1, 16 },
   { 0xD209, "KBCODE", 1, 'r', 1, 16 },
   { 0xD20A, "SKREST", 1, 'w', 1, 16 },
   { 0xD20A, "RANDOM", 1, 'r', 1, 16 },
   { 0xD20B, "POTGO", 1, 'a', 1, 16 },
   { 0xD20D, "SEROUT", 1, 'w', 1, 16 },
   { 0xD20D, "SERIN", 1, 'r', 1, 16 },
   { 0xD20E, "IRQEN", 1, 'w', 1, 16 },
   { 0xD20E, "IRQST", 1, 'r', 1, 16 },
   { 0xD20F, "SKCTL", 1, 'w', 1, 16 },
   { 0xD20F, "SKSTAT", 1, 'r', 1, 16 },
   { 0xD300, "PORTA", 1, 'a', 1, 16 },
   { 0xD301, "PORTB", 1, 'a', 1, 16 },
   { 0xD302, "PACTL", 1, 'a', 1, 16 },
   { 0xD303, "PBCTL", 1, 'a', 1, 16 },
   { 0xD400, "DMACTL", 1, 'a', 1, 16 },
   { 0xD401, "CHACTL", 1, 'a', 1, 16 },
   { 0xD402, "DLISTL", 1, 'a', 1, 16 },
   { 0xD403, "DLISTH", 1, 'a', 1, 16 },
   { 0xD404, "HSCROL", 1, 'a', 1, 16 },
   { 0xD405, "VSCROL", 1, 'a', 1, 16 },
   { 0xD407, "PMBASE", 1, 'a', 1, 16 },
   { 0xD409, "CHBASE", 1, 'a', 1, 16 },
   { 0xD40A, "WSYNC", 1, 'a', 1, 16 },
   { 0xD40B, "VCOUNT", 1, 'a', 1, 16 },
   { 0xD40C, "PENH", 1, 'a', 1, 16 },
   { 0xD40D, "PENV", 1, 'a', 1, 16 },
   { 0xD40E, "NMIEN", 1, 'a', 1, 16 },
   { 0xD40F, "NMIST", 1, 'w', 1, 16 },
   { 0xD40F, "NMIRES", 1, 'r', 1, 16 },
   { 0xD800, "AFP", 1, 'a', 1, 16 },
   { 0xD8E6, "FASC", 1, 'a', 1, 16 },
   { 0xD9AA, "IFP", 1, 'a', 1, 16 },
   { 0xD9D2, "FPI", 1, 'a', 1, 16 },
   { 0xDA44, "ZFR0", 1, 'a', 1, 16 },
   { 0xDA46, "ZF1", 1, 'a', 1, 16 },
   { 0xDA60, "FSUB", 1, 'a', 1, 16 },
   { 0xDA66, "FADD", 1, 'a', 1, 16 },
   { 0xDADB, "FMUL", 1, 'a', 1, 16 },
   { 0xDB28, "FDIV", 1, 'a', 1, 16 },
   { 0xDD40, "PLYEVL", 1, 'a', 1, 16 },
   { 0xDD89, "FLD0R", 1, 'a', 1, 16 },
   { 0xDD8D, "FLD0P", 1, 'a', 1, 16 },
   { 0xDD98, "FLD1R", 1, 'a', 1, 16 },
   { 0xDD9C, "FLD1P", 1, 'a', 1, 16 },
   { 0xDDA7, "FSTOR", 1, 'a', 1, 16 },
   { 0xDDAB, "FSTOP", 1, 'a', 1, 16 },
   { 0xDDB6, "FMOVE", 1, 'a', 1, 16 },
   { 0xDDC0, "EXP", 1, 'a', 1, 16 },
   { 0xDDCC, "EXP10", 1, 'a', 1, 16 },
   { 0xDECD, "LOG", 1, 'a', 1, 16 },
   { 0xDED1, "LOG10", 1, 'a', 1, 16 },
   { 0xE400, "EDITRV", 1, 'a', 1, 16 },
   { 0xE410, "SCRENV", 1, 'a', 1, 16 },
   { 0xE420, "KEYBDV", 1, 'a', 1, 16 },
   { 0xE430, "PRINTV", 1, 'a', 1, 16 },
   { 0xE440, "CASETV", 1, 'a', 1, 16 },
   { 0xE450, "DISKIV", 1, 'a', 1, 16 },
   { 0xE453, "DSKINV", 1, 'a', 1, 16 },
   { 0xE456, "CIOV", 1, 'a', 1, 16 },
   { 0xE459, "SIOV", 1, 'a', 1, 16 },
   { 0xE45C, "SETVBV", 1, 'a', 1, 16 },
   { 0xE45F, "SYSVBV", 1, 'a', 1, 16 },
   { 0xE462, "XITVBV", 1, 'a', 1, 16 },
   { 0xE465, "SIOINV", 1, 'a', 1, 16 },
   { 0xE468, "SENDEV", 1, 'a', 1, 16 },
   { 0xE46B, "INTINV", 1, 'a', 1, 16 },
   { 0xE46E, "CIOINV", 1, 'a', 1, 16 },
   { 0xE471, "BLKBDV", 1, 'a', 1, 16 },
   { 0xE474, "WARMSV", 1, 'a', 1, 16 },
   { 0xE477, "COLDSV", 1, 'a', 1, 16 },
   { 0xE47A, "RBLOKV", 1, 'a', 1, 16 },
   { 0xE47D, "CSOPIV", 1, 'a', 1, 16 },
   { 0xE480, "PUPDIV", 1, 'a', 1, 16 },
   { 0xE483, "SLFTSV", 1, 'a', 1, 16 },
   { 0xE486, "PHENTV", 1, 'a', 1, 16 },
   { 0xE489, "PHULNV", 1, 'a', 1, 16 },
   { 0xE48C, "PHINIV", 1, 'a', 1, 16 },
   { 0xE48F, "GPDVV", 1, 'a', 1, 16 },
   { 0xE7AE, "SYSVBL", 1, 'a', 1, 16 },
   { 0xE7D1, "SYSVBL", 1, 'a', 1, 16 },
 ...
 * add_label()
 */
const char *add_label(const char *name,int addr,int write)
{
...
int load_boot(const unsigned char *load,int size)
{
   ...
   if ( dosini >= target + 6 )
   {
      ...
      add_label("BOOT_INI",dosini,0);
   }
   branch_target[target+6] = 1;
   add_label("BOOT_EXEC",target+6,0);
   add_label("BOOT_SECS",target+1,0);
   add_label("BOOT_ADDR",target+2,0);
   add_label("LOAD_ADDR",target+4,0);
...
int load_rom(const unsigned char *load,int size)
{
   ...
   {
      add_label("CART_STRT",run,0);
      branch_target[run] = 1;
   }
   run = le16toh(*(uint16_t *)&mem[0xbffe]);
   if ( run >= addr && run < 0xc000 )
   {
      add_label("CART_INIT",run,0);
      branch_target[run] = 1;
   }
   return 0;
}
...
int load_binload(const unsigned char *load,int size)
{
   ...
   while ( size )
   {
      ...
      if ( start == 0x2e0 && end >= 0x2e1 )
      {
         start+=2;
         size-=2;
         add_label("RUN",le16toh(*(uint16_t *)&load[0]),0);
      ...
      if ( start == 0x2e2 && end >= 0x2e3 )
      {
         ...
         start+=2;
         size-=2;
         add_label(name,le16toh(*(uint16_t *)&load[0]),0);
         branch_target[le16toh(*(uint16_t *)&load[0])] = 1;
      }
      if ( start <= end )
      {
   ...
   while ( mem_loaded[addr] && !instruction[addr] && addr < 0xfffe )
   {
      ...
      else
      {
         ...
         switch(opcode[mem[addr]].mode)
         {
            ...
            case E_ABSOLUTE_X:
            case E_ABSOLUTE_Y:
               add_label(NULL,le16toh(*(uint16_t *)&mem[addr+1]),write);
               break;
            case E_ZEROPAGE:
            case E_ZEROPAGE_X:
            case E_ZEROPAGE_Y:
            ...
            case E_ZEROPAGE_IND_Y:
               add_label(NULL,mem[addr+1],write);
               break;
